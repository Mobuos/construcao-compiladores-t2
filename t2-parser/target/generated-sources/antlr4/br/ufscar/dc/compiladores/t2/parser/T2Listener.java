...
public interface T2Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link T2Parser#decl_local_global}.
	 * @param ctx the parse tree
	 */
	void enterDecl_local_global(T2Parser.Decl_local_globalContext ctx);
	/**
	 * Exit a parse tree produced by {@link T2Parser#decl_local_global}.
	 * @param ctx the parse tree
	 */
	void exitDecl_local_global(T2Parser.Decl_local_globalContext ctx);
	/**
